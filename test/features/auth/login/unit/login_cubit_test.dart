...
//   void setUpCubit() {
//     dio = Dio(
//       BaseOptions(baseUrl: 'https://fake.api/', validateStatus: (_) => true),
//     );
...
//   blocTest<LoginCubit, LoginState>(
//     '❌ emits [LoadingLoginState, ErrorLoginState] when server returns 422',
//     setUp: () => setUpCubit(),
//     tearDown: () {
//       loginCubit.close();
//       dioAdapter.close();
...
//           ),
//         ),
//         data: Matchers.any, // ✅ ضروري لو الداتا غير ثابتة
//       );
//       return loginCubit;
//     },
//     act: (cubit) {
...
//             (e) => e.error,
//             'error',
//             contains('The phone field is required.'),
//           ),
//         ],
//   );
